...
class GempaTerkini(db.Model):
    __tablename__ = 'gempa_terkini'
    ...
    potensi = db.Column(db.String)

    def __repr__(self):
        return f'<GempaTerkini(id={self.id}, tanggal={self.tanggal}, wilayah={self.wilayah})>'
